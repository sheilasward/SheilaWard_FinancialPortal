...
namespace SheilaWard_FinancialPortal.Controllers
{
    ...
    public class AccountController : Controller
    {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    if (string.IsNullOrEmpty(returnUrl))
                    {
                        ...
                        {
                            return RedirectToAction("Dashboard", "Households", new { id = currentUser.HouseholdId });
                        }
                    }
        ...
        public async Task<ActionResult> CustomResetPassword(CustomResetPasswordViewModel model)
        {
            ...
            if (result.Succeeded)
            {
                TempData["Message"] = "Your password has been reset. Please make sure you remember what your new password is - you will need it next time you sign on.";
                return RedirectToAction("Lobby", "Home");
            }
            AddErrors(result);
            return View();
